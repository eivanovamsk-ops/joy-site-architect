...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Подтвердите ваш email — Articon',
  invite: 'Приглашение в Articon',
  magiclink: 'Ссылка для входа — Articon',
  recovery: 'Восстановление пароля — Articon',
  email_change: 'Подтверждение смены email — Articon',
  reauthentication: 'Код подтверждения — Articon',
}
...
// Configuration
const SITE_NAME = "joy-site-architect"
const SENDER_DOMAIN = "notify.articon.pro"
const ROOT_DOMAIN = "articon.pro"
const FROM_DOMAIN = "articon.pro" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://joy-site-architect.lovable.app"
