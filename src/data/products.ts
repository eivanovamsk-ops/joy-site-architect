...
• Многоэлементный/несъемный зубной протез на имплантах`,
  ...
  },
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "Белый циркониевый диск Upcera ST для изготовления каркасов и мостовидных конструкций.",
    specifications: {
      "Толщина": "14 мм",
      "Диаметр": "98 мм",
      "Цвет": "Белый",
  ...
  },
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "Окрашенный циркониевый диск Upcera ST Color для изготовления эстетичных реставраций.",
    specifications: {
      "Толщина": "14 мм",
      "Диаметр": "98 мм",
      "Цвет": "A1",
  ...
  {
    id: "topcore-model-beige",
    name: "TOPCORE Model Beige",
    description: "Профессиональная смола для печати стоматологических моделей. Высокая точность и стабильность размеров.",
    price: 5900,
    image: "https://articon.pro/wp-content/uploads/2024/01/topcore-model.jpg",
    category: "3d-print",
    subcategory: "photopolymers",
    brand: "TOPCORE",
    inStock: true,
    ...
    externalUrl: "https://articon.pro/product/topcore-model/",
  },
  {
    id: "topcore-surgical-guide",
    name: "TOPCORE Surgical Guide",
    description: "Биосовместимая прозрачная смола для хирургических шаблонов. Класс I по биосовместимости.",
    price: 8200,
    image: "https://articon.pro/wp-content/uploads/2024/01/topcore-surgical.jpg",
    category: "3d-print",
    subcategory: "photopolymers",
    brand: "TOPCORE",
    isNew: true,
    ...
    externalUrl: "https://articon.pro/product/topcore-surgical/",
  },
  {
    id: "topcore-temp-crown-a2",
    name: "TOPCORE Temp Crown A2",
    description: "Смола для временных коронок и мостовидных протезов. Цвет A2, отличная эстетика.",
    price: 7800,
    image: "https://articon.pro/wp-content/uploads/2024/01/topcore-temp.jpg",
    category: "3d-print",
    subcategory: "photopolymers",
    brand: "TOPCORE",
    inStock: true,
    ...
    externalUrl: "https://articon.pro/product/topcore-temp-crown/",
  },
  {
    id: "topcore-cast-red",
    name: "TOPCORE Cast Red",
    description: "Выжигаемая смола красного цвета для литья металлических каркасов. Нулевой зольный остаток.",
    price: 8500,
    image: "https://articon.pro/wp-content/uploads/2024/01/topcore-cast.jpg",
    category: "3d-print",
    subcategory: "photopolymers",
    brand: "TOPCORE",
    inStock: true,
    ...
    externalUrl: "https://articon.pro/product/topcore-cast/",
  },
  {
    id: "topcore-gingiva-pink",
    name: "TOPCORE Gingiva Pink",
    description: "Гибкая смола для печати десневых масок. Естественный розовый цвет, эластичность.",
    price: 7500,
    image: "https://articon.pro/wp-content/uploads/2024/01/topcore-gingiva.jpg",
    category: "3d-print",
    subcategory: "photopolymers",
    brand: "TOPCORE",
    inStock: true,
    ...
    specifications: {
      ...
      "Цвет": "Розовый",
      "Длина волны": "385-405 нм",
      "Применение": "Десневые маски",
    },
    externalUrl: "https://articon.pro/product/topcore-gingiva/",
  },
  ...
  // DD Bio ZX² color
  {
    ...
    inStock: true,
    sku: "G 592.017.0",
    description: "Высокопрозрачная предокрашенная заготовка из циркония DD Bio ZX² color для изготовления монолитных коронок и мостов любого диапазона, виниров, индивидуальных абатментов.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "14 мм",
      "Цвет": "C1",
  ...
  },
  {
    ...
    inStock: true,
    sku: "G 590.012.0",
    description: "Высокопрозрачная предокрашенная заготовка из циркония DD Bio ZX² color 98×10 мм, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "10 мм",
      "Цвет": "A1",
  ...
  // === Циркониевые диски 4D plus ML (Honchon Smile) ===
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок, обладающий преимуществами с точки зрения износостойкости, свойств прилегания к краям, стирания, устойчивости к разрушению.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "12 мм",
      "Прозрачность": "43-55%",
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×14 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "14 мм",
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×16 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "16 мм",
    },
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×18 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "18 мм",
    },
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×20 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "20 мм",
    },
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×22 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "22 мм",
    },
  ...
  },
  {
    ...
    brand: "Honchon Smile",
    inStock: true,
    description: "4D plus ML многослойный циркониевый блок 98×25 мм.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "25 мм",
    },
  ...
  // === Диски пластиковые PMMA ===
  {
    ...
    brand: "Dental Direkt",
    inStock: true,
    description: "Диск PMMA Bio splint P HI для создания штифтов, терапевтических шин, регуляторов прикуса и протезов. Высокая ударопрочность.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "15 мм",
      "Материал": "PMMA",
  ...
  },
  {
    ...
    brand: "Dental Direkt",
    inStock: true,
    description: "Диск PMMA Bio splint P HI 98×20 мм для создания шин и протезов.",
    specifications: {
      "Диаметр": "98 мм",
      "Высота": "20 мм",
      "Материал": "PMMA",
  ...
  // === Дисиликат лития UPCERA ===
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "UP.CAD HT – стоматологический материал на основе литиевого дисиликата для CAD/CAM. Прочность до 400 МПа.",
    specifications: {
      "Прочность": "400 MPa",
  ...
  },
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "Low Translucency – LT блоки для объёмных реставраций жевательных зубов.",
  ...
  },
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "Пресс-керамика UP.Press HT высокой прозрачности.",
  ...
  },
  {
    ...
    brand: "Upcera",
    inStock: true,
    description: "Пресс-керамика UP.Press LT низкой прозрачности.",
  ...
  // === Зуботехнические печи Dekema ===
  {
    ...
    brand: "Dekema",
    inStock: true,
    description: "Печь для обжига стоматологической керамики AUSTROMAT 624 с сенсорным экраном 7,5\" и 200 программами обжига.",
    specifications: {
  ...
  },
  {
    ...
    brand: "Dekema",
    inStock: true,
    description: "Комбинированная печь для обжига и прессования AUSTROMAT 654 press-i-dent с многоплунжерными кольцевыми системами.",
    specifications: {
      "Размеры": "653×383×343 мм",
      "Вес": "22 кг",
      "Питание": "230 В / 50-60 Гц",
  ...
  },
  {
    ...
    brand: "Dekema",
    inStock: true,
    description: "DEKEMA AUSTROMAT 674 оснащен тремя нагревательными элементами из SiC для обжига при температуре до 1530°C.",
    specifications: {
      "Размеры": "780×383×343 мм",
      "Вес": "24 кг",
      "Питание": "230 В / 50-60 Гц",
  ...
  // === Фрезерные станки ===
  {
    ...
    brand: "imes-icore",
    inStock: true,
    description: "Гибкая и компактная 5-осевая система фрезерования CORiTEC 150i для точной обработки круглых заготовок и блоков.",
    specifications: {
      "Размеры": "422×556×644 мм",
      "Количество осей": "5",
  ...
  },
  {
    ...
    brand: "imes-icore",
    inStock: true,
    description: "Автоматизированное решение CORiTEC 350i для обработки всех материалов: CoCr, Ti, ZrO2, PMMA, блоков CAD/CAM.",
    specifications: {
  ...
  // === Upcera Explore Functional (большой ассортимент) ===
  {
    ...
    description: "Upcera Explore Functional – многослойный диоксид циркония с градиентной прозрачностью для виниров, вкладок, накладок, коронок и мостовидных протезов.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "12 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×12, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "12 мм",
      "Цвет": "A2",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×14, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "14 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×14, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "14 мм",
      "Цвет": "A2",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×14, цвет A3.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "14 мм",
      "Цвет": "A3",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×16, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "16 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×16, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "16 мм",
      "Цвет": "A2",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×18, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "18 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×18, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "18 мм",
      "Цвет": "A2",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×20, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "20 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×20, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "20 мм",
      "Цвет": "A2",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×22, цвет A1.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "22 мм",
      "Цвет": "A1",
  ...
  },
  {
    ...
    description: "Upcera Explore Functional 98×22, цвет A2.",
    specifications: {
      "Диаметр": "98 мм",
      "Толщина": "22 мм",
      "Цвет": "A2",
