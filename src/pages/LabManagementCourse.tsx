...
const problemSlides: {
  ...
  {
    src: "/images/courses/course-24-review-kozinova.jpg",
    name: "Юлия",
    subtitle: "г. Орёл",
    paragraphs: [
      "«Есть небольшие погрешности в стратегиях для ПММА. Пришлось самостоятельно внести коррективы».",
      "Юлия приезжала к нам из Орла на курс по менеджменту для ЗТЛ в апреле прошлого года с запросом: выстроить рабочие алгоритмы в действующей ЗТЛ, распределить обязанности между специалистами, внедрить должностные инструкции и разработать систему учёта расходных материалов.",
    ],
    outro: "Хороший менеджмент связан с расширением горизонтов для бизнеса 😎",
  },
  {
    src: "/images/courses/course-24-review-zodiak.jpg",
    name: "Елена",
    subtitle: "собственник лаборатории «Зодиак»",
    paragraphs: [
      "Елена — собственник лаборатории Зодиак. Бизнес давно работает и многие процессы эффективно выстроены. При этом есть потребность в масштабировании и выстраивании алгоритмов внутри растущей компании и команды.",
      "Иногда вам просто нужна поддержка и вера в то, что вы всё правильно делаете. Мы рады вам в этом помочь: всё разложить по полочкам, показать аналогичные кейсы, где всё получилось!",
    ],
    outro: "Желаем вам успехов и процветания!",
  },
];
  ...
  return (
    <Layout>
      <div className="relative -mt-[116px] min-h-screen overflow-hidden bg-foreground text-background lg:-mt-[164px]">
        ...
        <section className="relative pt-20 pb-14 lg:pt-24 lg:pb-16">
          <div className="container mx-auto px-4">
