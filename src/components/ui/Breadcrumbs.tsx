...
export function Breadcrumbs() {
  ...
  if (pathnames.length === 0 || pathnames.includes("product") || pathnames.includes("course") || pathnames.includes("variant") || pathnames.includes("bundle") || pathnames.includes("brands")) {
    return null;
  }
