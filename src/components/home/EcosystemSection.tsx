...
const stats = [
  ...
  { value: "Топ-3", label: "лабораторий РФ" },
...
export function EcosystemSection() {
  return (
    <section className="py-20 lg:py-28 bg-secondary" itemScope itemType="https://schema.org/Organization">
          ...
          {ecosystemSteps.map((step, index) => {
            ...
            return (
              <div key={step.number} className="flex flex-col items-center">
                ...
                {index < ecosystemSteps.length - 1 && (
                  <ArrowDown className="h-5 w-5 text-primary my-2" />
                )}
              </div>
            );
          })}
