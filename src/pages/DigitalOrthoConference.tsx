...
const whyItems = [
  { icon: Target, title: "Цифра + хирургия", desc: "Уникальная коллаборация ортодонтии и челюстно-лицевой хирургии — разбор кейсов с двух сторон" },
...
const programItems = [
  { time: "09:00", title: "Начало регистрации", speaker: "", desc: "Регистрация участников, приветственный кофе." },
  { time: "10:00", title: "Доклады ведущих спикеров", speaker: "Спикеры конференции", desc: "Ортодонтические digital-кейсы, сравнительный анализ методик, разбор сложных случаев." },
  { time: "12:00", title: "Кофе-брейк", speaker: "", desc: "Перерыв, неформальное общение со спикерами." },
  { time: "12:30", title: "Хирургия + Ортодонтия", speaker: "Шипика Дмитрий & Екатерина Гизоева", desc: "Совместный разбор клинических кейсов на стыке ортодонтии и челюстно-лицевой хирургии." },
  { time: "14:00", title: "Обед", speaker: "", desc: "Перерыв на обед." },
  { time: "15:00", title: "Дискуссии и digital-кейсы", speaker: "Нуртдинов Ильяр", desc: "Авторские методики, разбор сложных случаев, ответы на вопросы." },
  { time: "17:00", title: "Фуршет и нетворкинг", speaker: "", desc: "Подведение итогов, вручение сертификатов и подарков, нетворкинг." },
];
