      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold mb-2">{course.format === 'Open Day' ? 'Цель встречи' : course.format === 'Воркшоп' ? 'Цель мероприятия' : 'Цель курса'}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="bg-card border border-border rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold">{(course.format === 'Open Day' || course.format === 'Воркшоп') ? 'Кому будет интересно' : 'Для кого этот курс'}</h2>
            </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold">{course.format === 'Open Day' ? 'Что вам даст встреча' : course.format === 'Воркшоп' ? 'Что вы получите' : 'Чему вы научитесь'}</h2>
            </div>
            <ul className="space-y-4">
        ...
        {course.lecturers.length > 0 && <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold">
                {(course.format === 'Open Day' || course.format === 'Воркшоп')
