...
const CourseCalendar = () => {
  ...
  const filteredCourses = useMemo(() => {
    const filtered = courses.filter((course) => {
      if (course.id === 13 || course.id === 23 || course.id === 25 || course.id === 10 || course.id === 26 || course.id === 30 || course.id === 42 || course.id === 43 || course.id === 44 || course.id === 45 || course.id === 46) return false;
    ...
    return filtered.sort((a, b) => {
     ...
     const isArchivedA = a.id === 19 || a.id === 11 || a.id === 21 || a.id === 22 || a.id === 42 || a.id === 43 || a.id === 44 || a.id === 45 || a.id === 46 || a.isPast;
     const isArchivedB = b.id === 19 || b.id === 11 || b.id === 21 || b.id === 22 || b.id === 42 || b.id === 43 || b.id === 44 || b.id === 45 || b.id === 46 || b.isPast;
