...
const CourseCalendar = () => {
  ...
  const filteredCourses = useMemo(() => {
    ...
    return filtered.sort((a, b) => {
     ...
     const isArchivedA = a.id === 19 || a.id === 11 || a.id === 21 || a.id === 22 || a.id === 42 || a.id === 43 || a.id === 44 || a.id === 45 || a.id === 46 || a.id === 47 || a.isPast;
     const isArchivedB = b.id === 19 || b.id === 11 || b.id === 21 || b.id === 22 || b.id === 42 || b.id === 43 || b.id === 44 || b.id === 45 || b.id === 46 || b.id === 47 || b.isPast;
