...
import eurokappaLogo from "@/assets/partners/eurokappa-logo.png";
...
const programItems = [
  ...
  { time: "12:40", title: "Осведомлен — вооружен. Или как не допустить осложнений при лечении трансверзальных аномалий", speaker: "Екатерина Гизоева", desc: "Как не допустить осложнений при лечении трансверзальных аномалий." },
  { time: "13:40", title: "Биомеханика ВНЧС: цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия", speaker: "Дмитрий Шипика", desc: "Цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия." },
  { time: "14:40", title: "Кофе-брейк", speaker: "", desc: "Перерыв, неформальное общение со спикерами." },
  { time: "15:30", title: "Управляемая цифровая ортодонтия на брекетах на примере клинических кейсов", speaker: "Ксения Дробаха", desc: "Управляемая цифровая ортодонтия на брекетах на примере клинических кейсов." },
  { time: "16:00", title: "Коррекция десневой улыбки, биомеханика интрузии с дистализацией, пирамидальные микроимплантаты", speaker: "Ильяр Нуртдинов", desc: "Коррекция десневой улыбки, биомеханика интрузии с дистализацией, пирамидальные микроимплантаты." },
  { time: "17:00", title: "Фуршет и живая музыка", speaker: "", desc: "Подведение итогов, фуршет и живая музыка." },
];
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 max-w-4xl mx-auto">
              {[
                ...
                { name: "Eurokappa", logo: eurokappaLogo },
              ].map((partner) => (
                <div
                  key={partner.name}
