...
• Совместимость – подходит для всех CAD/CAM систем`,
  ...
  // ==============================================
  {
    ...
    inStock: true,
    sku: "ART981501",
    description: `Диск PMMA 98×15 мм цвет A1 от Lima – это однослойная, предокрашенная блок-заготовка из полиметилакрилата (ПММА) диаметром 98 мм и высотой 15 мм, предназначенная для изготовления временных конструкций длительного ношения при помощи открытых CAD/CAM систем.
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a1-98-15/",
  },
  {
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a1-98-20/",
  },
  {
    ...
    inStock: true,
    sku: "ART981502",
    description: `Диск PMMA 98×15 мм цвет A2 от Lima – это однослойная, предокрашенная блок-заготовка из полиметилакрилата (ПММА) диаметром 98 мм и высотой 15 мм, предназначенная для изготовления временных конструкций длительного ношения при помощи открытых CAD/CAM систем.
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a2-98-15/",
  },
  {
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a2-98-20/",
  },
  {
    ...
    inStock: true,
    sku: "ART981503",
    description: `Диск PMMA 98×15 мм цвет A3 от Lima – это однослойная, предокрашенная блок-заготовка из полиметилакрилата (ПММА) диаметром 98 мм и высотой 15 мм, предназначенная для изготовления временных конструкций длительного ношения при помощи открытых CAD/CAM систем.
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a3-98-15/",
  },
  {
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a3-98-20/",
  },
  {
    ...
    inStock: true,
    sku: "ART981504",
    description: `Диск PMMA 98×15 мм цвет A3.5 от Lima – это однослойная, предокрашенная блок-заготовка из полиметилакрилата (ПММА) диаметром 98 мм и высотой 15 мм, предназначенная для изготовления временных конструкций длительного ношения при помощи открытых CAD/CAM систем.
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a3-5-98-15/",
  },
  {
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-a3-5-98-20/",
  },
  {
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-bl-98-20/",
  },
  {
    ...
    inStock: true,
    sku: "ART981500",
    description: `Диск PMMA 98×15 мм цвет W3 от Lima – это однослойная, предокрашенная блок-заготовка из полиметилакрилата (ПММА) диаметром 98 мм и высотой 15 мм, предназначенная для изготовления временных конструкций длительного ношения при помощи открытых CAD/CAM систем.
...
• Легко полируется`,
    ...
    externalUrl: "https://articonshop.ru/product/disk-pmma-w3-98-15/",
  },
  {
