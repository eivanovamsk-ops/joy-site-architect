...
const timeline = [
  ...
  { time: "20:00", title: "Фуршет и живая музыка", speaker: "", desc: "Завершение программы. Угощения, напитки, живое общение в расслабленной атмосфере. Отличный способ закончить насыщенную пятницу в хорошей компании." },
];
