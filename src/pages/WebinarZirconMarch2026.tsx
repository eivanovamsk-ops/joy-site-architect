...
const learningPoints = [
  <>Как правильно работать с диоксидом циркония, чтобы <strong>избежать распространённых ошибок</strong></>,
  <>Какие нюансы материала влияют на <strong>итоговую эстетику</strong></>,
  <>Как <strong>добиться стабильного оттенка</strong> и естественной глубины</>,
  <>Какие практические приёмы помогают <strong>сократить количество переделок</strong></>,
  <>Как <strong>оптимизировать рабочий процесс</strong> в лаборатории</>,
];
...
export default function WebinarZirconMarch2026() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        const { error: fnError } = for (const recipient of ["edu@articon.pro", "event@articon.pro"]) {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              На вебинаре вы разберёте практические лайфхаки работы с диоксидом циркония и узнаете, как добиться более предсказуемого 
