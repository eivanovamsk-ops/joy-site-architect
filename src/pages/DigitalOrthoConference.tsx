...
const programItems = [
  ...
  { time: "13:00", title: "Биомеханика ВНЧС: цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия", speaker: "Дмитрий Шипико", desc: "Цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия." },
  { time: "14:00", title: "Комплексное лечение на брекетах и элайнерах", speaker: "Ильяр Нуртдинов", desc: "Подходы к комплексному ортодонтическому лечению с использованием брекетов и элайнеров." },
