...
const categories = [
  { name: "SALE", icon: BadgePercent, color: "destructive" },
  { name: "3D-сканеры", icon: null, count: 24 },
  { name: "3D-принтеры", icon: null, count: 18 },
  { name: "Фрезерные станки", icon: null, count: 12 },
  { name: "Фрезы", icon: null, count: 85 },
  { name: "Циркониевые диски", icon: null, count: 45 },
  { name: "Фотополимеры", icon: null, count: 62 },
  { name: "Краски и глазурь", icon: null, count: 38 },
];
            ...
            {categories.map((category, index) => (
              <Link
                ...
                className={`bg-card border border-border rounded-xl p-4 text-center hover-lift ${
                  category.color === "destructive" ? "border-destructive" : ""
                }`}
              >
                <div
