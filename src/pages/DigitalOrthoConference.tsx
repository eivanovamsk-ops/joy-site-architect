...
const programItems = [
  ...
  { time: "12:00", title: "Биомеханика ВНЧС: цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия", speaker: "Дмитрий Шипико", desc: "Цифровая гнатология, малоинвазивная хирургия и аппаратная механотерапия." },
  { time: "13:00", title: "Комплексное лечение на брекетах и элайнерах", speaker: "Ильяр Нуртдинов", desc: "Подходы к комплексному ортодонтическому лечению с использованием брекетов и элайнеров." },
  { time: "14:00", title: "Кофе-брейк", speaker: "", desc: "Перерыв, неформальное общение со спикерами." },
  { time: "14:40", title: "Экскурсия по производству", speaker: "", desc: "Экскурсия по производству Артикон." },
  { time: "15:00", title: "Планирование ортодонтических аппаратов на скелетной опоре (SARPE, MARPE)", speaker: "Екатерина Гизоева", desc: "Планирование ортодонтических аппаратов на скелетной опоре." },
