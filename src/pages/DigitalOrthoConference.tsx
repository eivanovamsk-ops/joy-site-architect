  ...
  return (
    <Layout>
      <div className="doc-page bg-[#0A0E1A] text-[#F5F5F5] min-h-screen overflow-hidden -mt-[116px] lg:-mt-[164px]" style={{ fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        {/* ═══════ HERO ═══════ */}
        <section className="relative min-h-[75vh] lg:min-h-[85vh] flex items-center overflow-hidden pt-[116px] lg:pt-[164px]">
          <div ref={heroRef} className="absolute inset-0 will-change-transform">
            <img src={course22Banner} alt="IV Конференция Цифровая ортодонтия" className="w-full h-full object-cover" style={{ objectPosition: '70% 30%' }} loading="lazy" />
