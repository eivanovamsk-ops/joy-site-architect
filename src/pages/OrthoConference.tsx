...
const whyItems = [
  ...
  { icon: Zap, title: "Цифровые технологии", desc: "Планирование на элайнерах, виртуальный сетап, интраоральное сканирование — всё, что нужно современному ортодонту" },
...
const programItems = [
  {
    time: "10:00",
    title: "Начало конференции",
    speaker: "",
    desc: "Регистрация участников, приветственный кофе."
  },
  {
    time: "10:30",
    title: "Планирование лечения на элайнерах: от цифровой модели к идеальной окклюзии",
    speaker: "Анастасия Маркова",
    desc: "Как избежать ошибок на этапе планирования. Расстановка приоритетов. Использование виртуального сет-апа на 100%."
  },
  {
    time: "12:00",
    title: "Планирование ортодонтических аппаратов на скелетной опоре",
    speaker: "Екатерина Гизоева & Максим Исаев",
  ...
  {
    time: "14:00",
    title: "Интраоральное сканирование в практике ортодонта: больше, чем просто слепок",
    speaker: "Чеккуева Зухра",
    desc: "Как избежать артефактов, использование данных скана для планирования, повышение точности лечения."
  },
  {
    time: "16:00",
            ...
            <div ref={ctaReveal.ref} className={cn(
              ...
              <div className="mt-10 text-[#F5F5F5]/40 text-sm">
                ...
                <div className="flex flex-wrap justify-center gap-4 mt-2">
                  <a href="tel:+79057172061" className="hover:text-[#F5F5F5] transition-colors">8 (905) 717-20-61</a>
